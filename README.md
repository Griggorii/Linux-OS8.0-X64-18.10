...
Демо upstart в меню есть но пока не загружает upstart-OS8.0_Demo_Griggorii.zip

 svn support можно сделать jhalfs blfs с java upstart-OS8.0_Demo_Griggorii.tar.bz2 только для этой системы так что возможно скоро upstart заработает. 
